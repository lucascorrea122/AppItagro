...
export default class AeronaveIpanemaE extends Component{
    render(){
        return(
            <View style={styles.MainContainer}>
            <View style={styles.aeronavesContainer}>

                <Image source={require('../images/ipanema202A-2.jpg')}
                    ...
                    <Collapse >
                        ...
                        <CollapseBody style={{ justifyContent: 'center', backgroundColor: '#EDEDED', borderRadius:5 }}>
                            <View >
                                ...
                                <Text style={styles.textItem}>222km/h(138mph) Va (Motor a Etanol)</Text>
                            </View>
                            <View>
                                <Text style={styles.textDefinicao}>Cruzeiro a 65% da PMC: </Text>
                                <Text style={styles.textItem}>204km/h(127mph) Va (Motor a Etanol) </Text>
                            </View>
                            <View >
